...
export class ShareBoardComponent implements OnInit {
  ...
  public isAnonymousUser: boolean = false;
  ...
  async ngOnInit() {
    ...
    this.bordServiceV2
      .getBoardInvitation(this.boardId, this.invitationId)
      .get()
      .subscribe(async (invitationDocRef) => {
        ...
        this.boardOwner = (await this.accountService.getUserById(
          this.invitation.creator
        )) as User;
      });
